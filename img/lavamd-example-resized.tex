...
legend style={fill=none,draw=none,at={(0.5,1.3)},anchor=north,legend columns=4,line width=5pt},
]

\addplot[thick, dashed, black] coordinates {(0,1) (29,1)};
\addplot[thick, solid, color=s4] table[x index=1,y index=2,col sep=tab] {img/LAVAMD.txt};
