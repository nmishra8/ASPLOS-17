\begin{tikzpicture}
\begin{centering}
\pgfplotstableread[col sep=tab]{img/single-eff-summary.txt}{\datatableeff}
\pgfplotstableread[col sep=tab]{img/single-lat-summary.txt}{\datatablelat}
\begin{groupplot}[
...
%        ylabel={\tiny \textbf{Deadline Misses (\%)} \\ {\tiny (lower is better)}},
...
\nextgroupplot[
        ...
        xmin = 0,
        xmax = 13,
%        ylabel={\tiny \textbf{Energy Over Optimal (\%)} \\ {\tiny (lower is better)}},
