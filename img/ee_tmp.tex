...
%\pgfplotstableread[col sep=space]{img/single-app/dyn-eff-0.1.txt}\loadedtable;
\addplot table[x index=0,y index=2, col sep=space] {img/single-app/dyn2-eff-0.1.txt};
%\addplot table[x index=1,y index=2] {\loadedtable};
%\addplot table[x index=1,y index=2] {\loadedtable};

%\addplot table[x index=1,y index=2] {img/single-app/dyn-eff-0.1.txt};
