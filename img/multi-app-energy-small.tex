...
\pgfplotstableread[col sep=space]{img/image_text/ma-eff-0.60-v3.txt}{\datatablesixty}
\pgfplotstableread[col sep=space]{img/image_text/ma-eff-0.75-v3.txt}{\datatableseventyfive}
\pgfplotstableread[col sep=space]{img/image_text/ma-eff-0.90-v3.txt}{\datatableninty}
\begin{groupplot}[
    group style={
        group name=plots,
        group size=1 by 3,
...
ylabel shift={0mm},
bar width=2.0pt,
legend entries = {{$\mathsf{ONLINE}$},{$\mathsf{HBM}$},{$\mathsf{ADAPT-CONTROL}$},{$\mathsf{\SYSTEM{}-NP}$},{$\mathsf{HBM-ADAPT}$}},
...
\addplot+[color=ONLINE,fill=ONLINE]       table[x index=0,y index=4] {\datatablesixty};
\addplot[color=HBM,fill=HBM]     table[x index=0,y index=7] {\datatablesixty};
\addplot[color=ADAPT-CONTROL,fill=ADAPT-CONTROL]   table[x index=0,y index=9] {\datatablesixty};
\addplot[color=CALOREE-NP,fill=CALOREE-NP] table[x index=0,y index=10] {\datatablesixty};
\addplot[color=HBM-ADAPT,fill=HBM-ADAPT]     table[x index=0,y index=13] {\datatablesixty};
...
\addplot[color=ONLINE,fill=ONLINE] table[x index=0,y index=4] {\datatableseventyfive};
...
\addplot[color=ONLINE,fill=ONLINE] table[x index=0,y index=4] {\datatableninty};
\addplot[color=HBM,fill=HBM]       table[x index=0,y index=7] {\datatableninty};
\addplot[color=ADAPT-CONTROL,fill=ADAPT-CONTROL]  table[x index=0,y index=9] {\datatableninty};
\addplot[color=CALOREE-NP,fill=CALOREE-NP] table[x index=0,y index=10] {\datatableninty};
\addplot[color=HBM-ADAPT,fill=HBM-ADAPT] table[x index=0,y index=13] {\datatableninty};
