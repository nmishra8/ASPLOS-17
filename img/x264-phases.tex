...
\addplot[thick, solid, color=s3] table[x index=0,y index=6,col sep=space] {img/image_text/x264-native-ducks-better-results.txt};
\addplot[thick, solid, color=s4] table[x index=0,y index=4,col sep=space] {img/image_text/x264-native-ducks-better-results.txt};
\addplot[thick, solid, color=s5] table[x index=0,y index=2,col sep=space] {img/image_text/x264-native-ducks-better-results.txt};
...
\addplot[thick, dashed, black] coordinates {(14,0) (14, 2)};
...
\addplot[thick, solid, color=s3] table[x index=0,y index=7,col sep=space] {img/image_text/x264-native-ducks-better-results.txt};
\addplot[thick, solid, color=s4] table[x index=0,y index=5,col sep=space] {img/image_text/x264-native-ducks-better-results.txt};
\addplot[thick, solid, color=s5] table[x index=0,y index=3,col sep=space] {img/image_text/x264-native-ducks-better-results.txt};
...
\addplot[thick, dashed, black] coordinates {(14,0) (14, 5)};
\end{groupplot}
\end{centering}
