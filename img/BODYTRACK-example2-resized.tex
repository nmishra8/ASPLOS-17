...
\addplot[thick, solid, color=s5, mark=triangle, mark size=1pt] table[x index=0,y index=1,col sep=space] {img/dynamics-example-poet.txt};
\addplot[thick, solid, color=s3, mark=square, mark size=1pt] table[x index=0,y index=1,col sep=space] {img/dynamics-example-leopoetnp.txt};
