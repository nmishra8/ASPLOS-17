\begin{abstract}
  ...
  but does not model system dynamics; control theory provides formal
  guarantees of dynamic behavior, but struggles with complex,
  non-convex resource interaction. We therefore propose \SYSTEM{}, a
  combination of learning and control techniques that automatically
  adjusts resource usage to meet performance requirements in complex,
  dynamic environments.  \SYSTEM{}'s key contribution is the interface
