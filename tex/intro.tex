...
expose a huge range of application-dependent performance and energy
tradeoffs.  \emph{This paper's goal is to provide the benefits of
  control theoretic techniques in a general design that provides
  reliable performance and minimal energy -- even for applications we
  have not encountered before and with minimal input from users.}
...
\item \textit{Overhead:} We cannot use more energy solving these
  optimization problems than we save knowing the answer.
