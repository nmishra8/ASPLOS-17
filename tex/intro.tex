...
speedup is independent of these changes.  \PUNT{Learning is well
  suited to predicting speedup as a function of resource usage, even
  when the resources have complicated relationships.}  Second, is
...
In summary, control adjusts to dynamic environments while learning
