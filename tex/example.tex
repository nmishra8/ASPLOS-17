...
We motivate the need to combine learning and control techniques. We
first demonstrate how learning overcomes the challenge of complexity,
while even advanced adaptive control problems can struggle.  We then
show how control systems can adapt to dynamics, while learning
mechanisms cannot.  We conclude by showing how a naive combination of
learning and control can lead to worse behavior than either.
...
\figref{fig:STREAM_contour}.  This is a simple memory-bound
...
The second complication is that controller design assumes that models
...
results are shown in \figref{fig:not-simple}.  This combination of
