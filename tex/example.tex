...
their respective frequencies.\TODO{cite??}  We conclude by arguing for a
...
%They also provide formal guarantees about their dynamics despite the fact that they are built on relatively simple models.  
...
greatly complicate the problem.  Before (\figref{fig:lavamd_model}) we
