...
\figref{lavamd_contour} (see \secref{example}) shows that LAVAMD has a
...
big and LITTLE cores to keep energy near minimal.  \TODO{Do we need
  the vertical line here?  This is a single app run right?}
