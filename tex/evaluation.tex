...
\begin{figure*}[!t]
  \input{img/single-app-performance-small.tex}
   \vskip -.5em
  \caption{Deadline misses for single application scenario.}
...
\begin{figure*}[!t]
  \input{img/single-app-energy-small.tex}
   \vskip -.5em
  \caption{Energy over optimal for single application scenario.}
...
\begin{figure*}[t!]
  \input{img/multi-app-performance-small.tex}
   \vskip -.5em
  \caption{Deadline misses for multiple application scenario.}
...
\begin{figure*}[!t]
  \input{img/multi-app-energy-small.tex}
   \vskip -.5em
  \caption{Energy over optimal for multiple application scenario.}
