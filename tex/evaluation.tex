...
\figref{fig:application_variety}.  Each application has been instrumented
...
\item \textit{Online-P2I} -- This strategy observes the current
  ...
  power of the unobserved configurations. \PUNT{Note that the process
    ...
    This method uses only the observations and not the prior data.}We use the \textit{Online} learning model
...
resources and energy that drags down energy efficiency for all
approaches. 
...
\figref{fig:bodytrack-multiapp}.  The figures show time (measured in
