...
In the remainder of this section, we first describe a traditional
...
\cite{FSE2015,sysid,josep-isca2016}.  \PUNT{Finally, these techniques
  cannot minimize energy.  While \emph{optimal} control techniques
  exist, they find the minimal change in resources that can meet the
  goal; \ie{} they cannot minimize some other function of the
...
%We also provide a proxy for self tuning parameter in the later sections in case the learning algorithm cannot provide the confidence interval. 
