...
processors, like those illustrated in \figref{contour}.  This
...
The HBM (illustrated in \figref{HBM}) is a superior combination of the
...
\figref{pht}.  This figure shows a hypothetical example of the power
...
\begin{figure}
  \includegraphics[width=\columnwidth]{figures/perforamnce-hash-table.pdf}
...
is illustrated in \figref{pht}.  It consists of two arrays, the first
...
captures.  The example in \figref{pht} has a resolution of $0.1$.
...
For example, consider the PHT in \figref{pht} and an optimizer trying
